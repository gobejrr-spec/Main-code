...
import { Loader2, ArrowRight, User, Car, Eye, EyeOff } from "lucide-react";
        ...
        <form onSubmit={handleRegister} className="glass-card-elevated rounded-2xl p-8 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-2">
              ...
              <Input type="tel" value={form.phone} onChange={(e) => update("phone", e.target.value)} required className="h-11" placeholder="9911 2233" />
            </div>
          </div>
          <div className="space-y-2">
